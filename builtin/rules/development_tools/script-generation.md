---
description: 当需要生成脚本代码或编写自动化脚本时使用此规则——脚本生成规则，脚本代码生成规范和模板。包括：生成高质量的脚本代码；选择合适的脚本语言（Bash、Python、PowerShell等）；编写清晰可读的脚本代码；添加必要的注释和文档；处理命令行参数和环境变量；实现错误处理和异常捕获；优化脚本性能和执行效率；遵循脚本编写最佳实践；生成可重复执行的脚本；处理文件操作和系统调用；实现批量任务处理；编写跨平台兼容的脚本。每当用户提及"生成脚本"、"编写脚本"、"自动化脚本"、"批量处理"、"Shell脚本"、"Python脚本"、"PowerShell脚本"或需要脚本开发、自动化任务、批量处理时触发，无论脚本类型和使用场景如何。如果需要生成脚本代码或编写自动化脚本，请使用此规则。
---

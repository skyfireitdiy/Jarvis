...
- 参考规则：[架构图生成规则]({{ rule_file_dir }}/architecture_design/architecture-diagram-generation.md)
- 参考规则：[整洁架构]({{ rule_file_dir }}/architecture_design/clean_architecture.md)
- 参考规则：[SOLID 设计原则]({{ rule_file_dir }}/architecture_design/solid.md)
任务已完成，是否进行任务分析

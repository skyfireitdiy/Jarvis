...
Agent --> [Native .py Platform] : sends prompt
[Native .py Platform] --> [OpenAI API] : adapts & calls
[Native .py Platform] --> [Kimi API] : adapts & calls
[Native .py Platform] --> [腾讯元宝 API] : adapts & calls
[Native .py Platform] --> [Other LLM APIs] : adapts & calls
...
[Memory Manager] --> [Memory Tools\n(save/retrieve/clear)] : manages
[Memory Tools\n(save/retrieve/clear)] --> [Short-term Memory\n(In-memory)] : accesses
[Memory Tools\n(save/retrieve/clear)] --> [Project Long-term Memory\n(.jarvis/memory)] : accesses
[Memory Tools\n(save/retrieve/clear)] --> [Global Long-term Memory\n(~/.jarvis/data/memory)] : accesses

Agent --> [Memory Manager] : uses
ToolRegistry --> [Memory Tools\n(save/retrieve/clear)] : loads

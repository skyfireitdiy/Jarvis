...
我们采用标准的 Fork & Pull Request 工作流。Jarvis 在 GitHub 和 Gitee 都有镜像仓库，您可以选择其中任一平台进行贡献：

- **GitHub**: https://github.com/skyfireitdiy/Jarvis.git
- **Gitee**: https://gitee.com/skyfireitdiy/Jarvis.git

1. **Fork 仓库**: 首先，访问您偏好的平台（GitHub 或 Gitee）上的 Jarvis 仓库页面，点击 "Fork" 或 "Forked From" 按钮，将项目复刻到您自己的账户下。

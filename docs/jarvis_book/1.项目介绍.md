...
package "Jarvis 核心框架 (Jarvis Core Framework)" #LightGreen {
  ...
  [文件方法论管理器] as FileMethodologyManager
...
Agent <--> FileMethodologyManager : "文件上传/方法论加载"
Agent <--> MemoryManager : "存储/检索"
FileMethodologyManager <--> LocalMethodology : "读取/加载"
...
CustomTools <--> CentralTools : "分享/同步（经 ShareManager）"

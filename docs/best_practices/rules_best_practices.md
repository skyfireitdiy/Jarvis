...
JARVIS 内置了以下规则，位于 `builtin/rules/` 目录：
...
| `sdd.md`                                   | 软件设计文档  | 设计文档编写   |
| `ios-dark-theme.md` / `ios-light-theme.md` | UI 主题规范   | 前端界面开发   |
| `generate_rules.md`                        | 规则生成指南  | 创建新规则时   |
| `ignore_all_alerts.md`                     | 忽略警告      | 特殊场景使用   |

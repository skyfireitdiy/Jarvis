---
description: 当需要系统进化、能力提升、自动学习或自我优化时使用此规则——自我进化规则，定义了Jarvis自我进化的核心原则和行为准则。包括：分析现有能力和局限性；识别需要改进的功能领域；制定进化计划和目标；添加新的技能和规则；优化现有代码和逻辑；学习新的知识和模式；适应新的环境和需求；执行自我测试和验证；记录进化决策和过程；保持向后兼容性；持续迭代和改进。每当用户提及"自我进化"、"系统进化"、"能力提升"、"自动学习"、"自我优化"、"系统改进"、"学习新技能"或需要系统进化、能力提升、自动学习、自我优化时触发，无论进化类型和改进范围如何。如果需要让系统自我学习和进化，请使用此规则。
---

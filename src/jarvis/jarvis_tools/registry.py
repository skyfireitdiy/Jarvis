...
**关键规则**
1. 一次可调用一个或多个工具；多个工具之间必须**互不依赖**（前者的结果/副作用不能作为后者的输入），有依赖时先执行被依赖的工具、等待结果后再继续
            ...
            if ch == "{":
                ...
                if json_str:
                    try:
                        ...
                        save_exception(
                            e, module="jarvis_tools.registry", function="can_handle"
                        )
                        continue
            ...
            if ch == "{":
                ...
                try:
                    ...
                    save_exception(
                        ...
                        function="_fuzzy_extract_tool_json",
                    )
                    continue
        return results
                ...
                if json_str:
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_tools.registry",
                            function="_parse_tool_call_format",
                        )
                        continue
                    ...
                    if json_str:
                        try:
                            ...
                            save_exception(
                                e,
                                module="jarvis_tools.registry",
                                function="_parse_special_marker_format",
                            )
                            continue
            else:
                # 有结束标记，提取标记之间的内容
        ...
        for match in matches:
            ...
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_tools.registry",
                    function="_parse_function_call_format",
                )
                continue
        return ret
        ...
        for match in matches:
            ...
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_tools.registry",
                    function="_parse_tool_name_json_format",
                )
                continue
        return ret
                ...
                if close_tag_pos != -1:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_tools.registry",
                            function="_parse_xml_tag_format",
                        )
                        pass
        return ret
            ...
            for param_match in re.finditer(param_pattern, inner_content, re.DOTALL):
                ...
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_tools.registry",
                        function="_parse_xml_parameter_format",
                    )
                    pass
            ...
            if params_content.startswith("{"):
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_tools.registry",
                        function="_parse_tool_calls_xml_format",
                    )
                    pass
        ...
        for match in filtered_matches:
            ...
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_tools.registry",
                    function="_parse_code_block_format",
                )
                pass
                ...
                if json_str:
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_tools.registry",
                            function="_parse_embedded_json_format",
                        )
                        continue
        return ret
        ...
        try:
            ...
            if agent is not None:
                try:
                    ...
                    save_exception(
                        e, module="jarvis_tools.registry", function="_save_parse_error"
                    )
                    pass
        ...
        def _compact_json(match: re.Match) -> str:
            ...
            if stripped.startswith("{") or stripped.startswith("["):
                try:
                    ...
                    save_exception(
                        e, module="jarvis_tools.registry", function="_compact_json"
                    )
                    pass
    ...
    def handle_tool_calls(self, tool_call: Dict[str, Any], agent: Any) -> str:
        try:
            ...
            try:
                ...
                save_exception(
                    e, module="jarvis_tools.registry", function="handle_tool_calls"
                )
                pass

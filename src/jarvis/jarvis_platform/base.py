...
from jarvis.jarvis_utils.utils import create_close_tag, ot, get_context_token_count, while_success, while_true
...
class BasePlatform(ABC):
    ...
    def chat_until_success(self, message: str) -> str:
        def _chat():
            ...
            response = re.sub(ot("think")+r'.*?'+create_close_tag("think"), '', response, flags=re.DOTALL)
            return response

...
class RuleShareManager(ShareManager):
    ...
    def get_existing_resources(self) -> Dict[str, str]:
        ...
        for filepath in glob.glob(
            ...
            try:
                ...
                save_exception(e, module="jarvis_agent.rule_share_manager", function="get_existing_resources")
                pass
    ...
    def get_local_resources(self) -> List[Dict[str, Any]]:
        ...
        # 获取所有规则目录
        from jarvis.jarvis_utils.template_utils import _get_builtin_dir, get_git_root
        ...
        for directory in set(rule_dirs):
            ...
            for filepath in glob.glob(
                ...
                try:
                    ...
                    save_exception(e, module="jarvis_agent.rule_share_manager", function="get_local_resources")
                    pass

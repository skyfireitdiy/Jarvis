...
class TaskAnalyzer:
    ...
    def analysis_task(self, satisfaction_feedback: str = "") -> None:
        ...
        try:
            ...
            try:
                ...
                save_exception(e, module="jarvis_agent.task_analyzer", function="analysis_task")
                pass
    ...
    def _prepare_analysis_prompt(self, satisfaction_feedback: str) -> str:
        ...
        try:
            ...
            save_exception(e, module="jarvis_agent.task_analyzer", function="_prepare_analysis_prompt")
            pass
    ...
    def _process_analysis_loop(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                save_exception(e, module="jarvis_agent.task_analyzer", function="_process_analysis_loop")
                pass
    ...
    def trigger_task_analysis(self, auto_completed: bool = False) -> None:
        ...
        try:
            ...
            save_exception(e, module="jarvis_agent.task_analyzer", function="trigger_task_analysis")
            pass
    ...
    def _collect_execution_steps(self) -> List[str]:
        ...
        try:
            ...
            save_exception(e, module="jarvis_agent.task_analyzer", function="_collect_execution_steps")
            pass

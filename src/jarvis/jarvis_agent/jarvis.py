    ...
    if skip_selector:
        try:
            ...
            try:
                ...
                save_exception(e, module="jarvis_agent.jarvis", function="handle_builtin_config_selector")
                pass
    ...
    if web_gateway:
        try:
            ...
            try:
                ...
                save_exception(e, module="jarvis_agent.jarvis", function="on_status_update")
                pass

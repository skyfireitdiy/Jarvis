                ...
                async with session.get(
                    ...
                    for item in data.get('skills', []):
                        ...
                        results.append(SkillResult(
                            ...
                            download_url=f"https://raw.githubusercontent.com/{repo_full}/main/SKILL.md" if repo_full else "",
                            source_url=f"https://www.skillhub.club/skills/{skill_id}" if skill_id else "",
                            relevance_score=self._calc_relevance(query, f"{item.get('name', '')} {item.get('description', '')}"),

            ...
            for gid_val in vr.get("gids", []):
                try:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.verification",
                            function="build_gid_to_verification_mapping",
                        )
                        pass
        elif "gid" in vr:
            try:
...
def merge_verified_items(
    ...
    for c in batch:
        try:
            ...
            save_exception(
                e, module="jarvis_sec.verification", function="merge_verified_items"
            )
            pass
    ...
    for c in batch:
        try:
            ...
            save_exception(
                e,
                module="jarvis_sec.verification",
                function="merge_verified_items_without_verification",
            )
            pass
            ...
            try:
                ...
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_sec.verification",
                        function="run_verification_agent_with_retry",
                    )
                    pass
...
def process_verification_batch(
        ...
        for item in batch:
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_sec.verification",
                    function="process_verification_batch",
                )
                pass
    ...
    try:
        ...
        save_exception(
            e, module="jarvis_sec.verification", function="process_verification_batch"
        )
        pass
    ...
    if completed_cluster_ids:
        try:
            ...
            save_exception(
                e,
                module="jarvis_sec.verification",
                function="process_verification_phase",
            )
            pass
        ...
        if not is_batch_completed and batch_gids and analyzed_gids:
            ...
            if not missing_gids:  # 所有 gid 都已分析
                ...
                try:
                    ...
                    save_exception(
                        e, module="jarvis_sec.verification", function="normalize_path"
                    )
                    pass

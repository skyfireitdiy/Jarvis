                        ...
                        if all_false_positive:
                            for gid_val in gids_list:
                                try:
                                    ...
                                    save_exception(e, module="jarvis_sec.clustering", function="load_existing_clusters")
                                    pass
    ...
    for _file, _items in _file_groups.items():
        for it in _items:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="restore_clusters_from_checkpoint")
                pass
...
def create_cluster_snapshot_writer(
    ...
    def _write_cluster_batch_snapshot(batch_records: List[Dict[str, Any]]) -> None:
        ...
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="_write_cluster_batch_snapshot")
            pass
    ...
    def _write_cluster_report_snapshot() -> None:
        ...
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="_write_cluster_report_snapshot")
            pass
    ...
    for _file, _items in file_groups.items():
        for it in _items:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="collect_candidate_gids")
                pass
    return all_gids
    ...
    for batch in cluster_batches:
        for item in batch:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="collect_clustered_gids")
                pass
                    ...
                    if is_auto_created:
                        ...
                        if gid in cluster_report_gids:
                            ...
                            try:
                                ...
                                save_exception(e, module="jarvis_sec.clustering", function="filter_single_gid_clusters")
                                pass
                    else:
            ...
            for x in raw_gids:
                try:
                    ...
                    try:
                        ...
                        save_exception(e, module="jarvis_sec.clustering", function="extract_classified_gids")
                        pass
                    continue
...
def run_cluster_agent_direct_model(
    ...
    try:
        ...
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="run_cluster_agent_direct_model")
            pass
    ...
    while True:
        ...
        if parse_error and _attempt == 1:
            ...
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="run_cluster_agent_with_retry")
                pass
    ...
    try:
        for it in pending_in_file_with_ids:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="process_cluster_results")
                pass
    except Exception:
        gid_to_item = {}
...
def extract_input_gids(pending_in_file_with_ids: List[Dict[str, Any]]) -> set[int]:
    ...
    for it in pending_in_file_with_ids:
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="extract_input_gids")
            pass
    return input_gids
    ...
    try:
        for it in pending_in_file_with_ids:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="build_gid_to_item_mapping")
                pass
    except Exception as e:
        save_exception(e, module="jarvis_sec.clustering", function="build_gid_to_item_mapping")
        pass
...
def process_cluster_chunk(
    ...
    while True:
        ...
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="process_cluster_chunk")
            pass
        cluster_agent = create_cluster_agent(
            file, chunk_idx, force_save_memory=force_save_memory
        )
...
def filter_pending_items(
    ...
    for c in items:
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="filter_pending_items")
            pass
...
def check_unclustered_gids(
    ...
    if unclustered_gids:
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="check_unclustered_gids")
            pass
    else:
        try:
            PrettyOutput.auto_print(
...
def record_clustering_completion(
    ...
    try:
        ...
        save_exception(e, module="jarvis_sec.clustering", function="record_clustering_completion")
        pass
    ...
    for _file, _items in file_groups.items():
        for c in _items:
            try:
                ...
                save_exception(e, module="jarvis_sec.clustering", function="fallback_to_file_based_batches")
                pass
...
def process_clustering_phase(
    ...
    if missing_gids_final:
        ...
        try:
            ...
            save_exception(e, module="jarvis_sec.clustering", function="process_clustering_phase")
            pass

    ...
    if path.exists():
        try:
            with path.open("r", encoding="utf-8", errors="ignore") as f:
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.file_manager",
            ...
            try:
                ...
                save_exception(
                    e, module="jarvis_sec.file_manager", function="load_candidates"
                )
                pass
...
def get_all_candidate_gids(sec_dir: Path) -> Set[int]:
    ...
    for candidate in candidates:
        try:
            ...
            save_exception(
                e, module="jarvis_sec.file_manager", function="get_all_candidate_gids"
            )
            pass
    return gids
    ...
    if path.exists():
        try:
            ...
            try:
                ...
                save_exception(
                    e, module="jarvis_sec.file_manager", function="load_clusters"
                )
                pass
            ...
            for gid_val in gids_list:
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_sec.file_manager",
                        function="get_all_clustered_gids",
                    )
                    pass
    return gids
                ...
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.file_manager",
                            function="load_analysis_results",
                        )
                        pass
            ...
            for gid_val in gids_list:
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_sec.file_manager",
                        function="get_all_analyzed_gids",
                    )
                    pass
    return gids
            ...
            for gid_val in verified_gids:
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_sec.file_manager",
                        function="get_verified_issue_gids",
                    )
                    pass
    return gids
            ...
            for gid_val in false_positive_gids:
                try:
                    ...
                    save_exception(
                        e,
                        module="jarvis_sec.file_manager",
                        function="get_false_positive_gids",
                    )
                    pass
    return gids

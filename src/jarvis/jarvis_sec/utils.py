...
def load_or_run_heuristic_scan(
    ...
    if candidates:
        try:
            ...
            save_exception(
                e, module="jarvis_sec.utils", function="load_or_run_heuristic_scan"
            )
            pass
    else:
    ...
    if not all_have_gid:
        ...
        for it in compact_candidates:
            try:
                ...
                save_exception(
                    e, module="jarvis_sec.utils", function="prepare_candidates"
                )
                pass
        ...
        try:
            ...
            if not batch or not candidates:
                ...
                try:
                    ...
                    save_exception(
                        e, module="jarvis_sec.utils", function="_append_report"
                    )
                    pass
                return
...
def load_processed_gids_from_issues(sec_dir: Path) -> Set[int]:
    ...
    try:
            ...
            with _agent_issues_path.open("r", encoding="utf-8", errors="ignore") as f:
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.utils",
                            function="load_processed_gids_from_issues",
                        )
                        pass
            if processed_gids:
                try:
        ...
        save_exception(
            e, module="jarvis_sec.utils", function="load_processed_gids_from_issues"
        )
        pass
                ...
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.utils",
                            function="count_issues_from_file_old",
                        )
                        pass
    except Exception as e:
        save_exception(
            e, module="jarvis_sec.utils", function="count_issues_from_file_old"
        )
        pass
    return count
    ...
    try:
        ...
        if _agent_issues_path.exists():
                ...
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.utils",
                            function="load_all_issues_from_file",
                        )
                        pass
            ...
            try:
                ...
                save_exception(
                    e, module="jarvis_sec.utils", function="load_all_issues_from_file"
                )
                pass
    except Exception as e:
        # 加载失败不影响主流程
                ...
                for line in f:
                    ...
                    try:
                        ...
                        save_exception(
                            e,
                            module="jarvis_sec.utils",
                            function="load_processed_gids_from_agent_issues",
                        )
                        pass
    except Exception as e:
        save_exception(

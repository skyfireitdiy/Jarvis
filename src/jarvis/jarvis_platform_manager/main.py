    ...
    try:
        ...
        if backup_file.exists():
            try:
                ...
                save_exception(e, module="jarvis_platform_manager.main", function="_save_config")
                pass
        return False
...
def chat_with_model(
    ...
    try:
        ...
        try:
            ...
            save_exception(e, module="jarvis_platform_manager.main", function="chat_with_model")
            pass

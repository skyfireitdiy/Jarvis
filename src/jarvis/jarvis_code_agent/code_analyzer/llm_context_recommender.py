...
from jarvis.jarvis_utils.config import get_cheap_model_name, read_text_file, save_exception
            ...
            for file in files:
                ...
                try:
                    ...
                    try:
                        ...
                        save_exception(e, module="jarvis_code_agent.code_analyzer.llm_context_recommender", function="format_progress_msg")
                        pass

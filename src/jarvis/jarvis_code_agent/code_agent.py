                ...
                if commits:
                    ...
                    if end_hash:
                        try:
                            ...
                            save_exception(e, module="jarvis_code_agent.code_agent", function="_on_after_tool_call")
                            pass
                ...
                try:
                    ...
                    if exit_code != 0 and error_message:
                        ...
                        try:
                            ...
                            save_exception(e, module="jarvis_code_agent.code_agent", function="_convert_to_string")
                            pass

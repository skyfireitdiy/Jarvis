...
def _clear_previous_prompt(text: str) -> None:
    ...
    try:
        ...
        save_exception(e, module="jarvis_utils.input", function="_clear_previous_prompt")
        pass
...
def _get_current_agent_for_input() -> Optional[Any]:
    try:
        ...
        save_exception(e, module="jarvis_utils.input", function="_get_current_agent_for_input")
        pass
    return None
    ...
    try:
        ...
        if ag is not None and hasattr(ag, "auto_complete"):
            try:
                ...
                save_exception(e, module="jarvis_utils.input", function="_is_auto_complete_for_current_agent")
                pass
        return False
    except Exception:
        return False
        ...
        if not first_enter_hint_shown and not _multiline_hint_already_shown():
            ...
            def _show_notice() -> None:
                ...
                try:
                    ...
                    save_exception(e, module="jarvis_utils.input", function="_show_notice")
                    pass
    ...
    while True:
        ...
        if user_input == CTRL_X_SENTINEL:
            ...
            try:
                ...
                save_exception(e, module="jarvis_utils.input", function="_get_input_via_provider")
                pass
            tip = f"已插入文件，继续编辑或按{submit_keys_display}确认:"
            continue
        else:

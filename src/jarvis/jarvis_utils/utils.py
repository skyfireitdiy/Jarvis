                ...
                if uv_dir.exists() and argv0_path.is_relative_to(uv_dir):
                    ...
                    if uv_exe:
                        try:
                            ...
                            save_exception(e, module="jarvis_utils.utils", function="_is_installed_via_uv_tool")
                            pass
            except Exception as e:
                save_exception(e, module="jarvis_utils.utils", function="_is_installed_via_uv_tool")
                pass
...
def _check_pip_updates() -> bool:
    ...
    if last_check_file.exists():
        try:
            ...
            save_exception(e, module="jarvis_utils.utils", function="_check_pip_updates")
            pass
        ...
        try:
            ...
            def show_stats_async() -> None:
                try:
                    ...
                    save_exception(e, module="jarvis_utils.utils", function="show_stats_async")
                    pass
...
def is_context_overflow(
    ...
    if platform is not None:
        try:
            ...
            save_exception(e, module="jarvis_utils.utils", function="is_context_overflow")
            pass

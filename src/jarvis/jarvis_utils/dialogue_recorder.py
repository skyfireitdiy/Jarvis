...
class DialogueRecorder:
    ...
    def read_session(self, session_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            save_exception(
                e, module="jarvis_utils.dialogue_recorder", function="read_session"
            )
            pass
        return messages
    ...
    def cleanup_session(self, session_id: Optional[str] = None) -> None:
        ...
        if file_path.exists():
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_utils.dialogue_recorder",
    ...
    def _ensure_data_dir(self) -> None:
        ...
        try:
            ...
            save_exception(
                e, module="jarvis_utils.dialogue_recorder", function="_ensure_data_dir"
            )
            pass
    ...
    def _write_record(self, record: Dict[str, Any]) -> None:
        ...
        try:
            ...
            save_exception(
                e, module="jarvis_utils.dialogue_recorder", function="_write_record"
            )
            pass

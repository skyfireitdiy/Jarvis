...
def _load_methodologies_from_dir(directory: str) -> Dict[str, str]:
    ...
    for filepath in glob.glob(os.path.join(directory, "*.json")):
        try:
            ...
            save_exception(e, module="jarvis_utils.methodology", function="_load_methodologies_from_dir")
            continue
...
"""
        ...
        try:
            ...
            save_exception(e, module="jarvis_utils.methodology", function="load_methodology")
            pass

...
<!-- 终端面板 -->
    ...
    <EditorPanel
      ...
      :currentAgentId="currentAgentId"
      :hasFileTree="hasEditorSidebarFileTree"
      :getVisibleNodes="getVisibleFileTreeNodes"
      :resolvePath="resolveAgentRelativePath"
      :searchQuery="globalSearchQuery"
      :searchFileGlob="globalSearchFileGlob"
      :searchCaseSensitive="globalSearchCaseSensitive"
      :searchWholeWord="globalSearchWholeWord"
      :searchLoading="globalSearchLoading"
      :searchError="globalSearchError"
      :searchExecuted="globalSearchExecuted"
      :searchTotalMatches="globalSearchTotalMatches"
      :searchTotalFiles="globalSearchTotalFiles"
      ...
      @ensureFileTree="ensureEditorSidebarFileTree"
      @fileNodeClick="handleFileTreeNodeClick"
      @update:searchQuery="globalSearchQuery = $event"
      @update:searchFileGlob="globalSearchFileGlob = $event"
      @update:searchCaseSensitive="globalSearchCaseSensitive = $event"
      @update:searchWholeWord="globalSearchWholeWord = $event"
      @runSearch="runGlobalSearch"
      @clearSearch="clearGlobalSearch"
      @openFile="openEditorFile"
      @openSearchResult="openGlobalSearchResult"

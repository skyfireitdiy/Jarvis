...
const WELCOME_TOUR_STEPS = [
  ...
  },
  {
    ...
    icon: '🧩',
    title: '更多入口',
    desc: '命令面板里还藏着不少实用能力：隐藏/显示宠物（Ctrl+Alt+B）、隐藏/显示全部输出、刷新与同步 Agent 状态、退出登录；管理员还可重启网关/节点、打开管理面板。',
    hint: '「安装浏览器插件」可让 Jarvis 操作你浏览器中的网页；「查看网络拓扑」可看节点连接全貌。',
  },
  {
    id: 'welcome-start',
    icon: '🚀',
  ...
  return [
    {
      ...
      hint: '输入 @ 可唤起补全列表，快速引用文件或命令；按住右 Ctrl 键可语音输入。',

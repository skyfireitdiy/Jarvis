...
class BuildManager:
    ...
    def detect_crate_kind(self) -> str:
        ...
        try:
            ...
            save_exception(e, module="jarvis_c2rust.transpiler_build", function="detect_crate_kind")
            pass
        # 默认假设为 lib
        return "lib"
                ...
                if compiler_has_warnings:
                    ...
                    if clippy_has_warnings:
                        ...
                        try:
                            ...
                            save_exception(e, module="jarvis_c2rust.transpiler_build", function="run_cargo_test_and_fix")
                            pass
                        return (True, False)
        else:
            # 测试失败

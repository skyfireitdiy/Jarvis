...
def _try_import_libclang() -> Any:
    ...
    try:
        ...
        for d in extra_glob_dirs:
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_c2rust.scanner",
                    function="_ensure_supported_and_set",
                )
                pass
    ...
    try:
        ...
        save_exception(
            e, module="jarvis_c2rust.scanner", function="_ensure_supported_and_set"
        )
        pass
    ...
    def _sym_record_from_type(tp: TypeInfo, id_val: int) -> Dict[str, Any]:
        ...
        if tp.underlying_type:
            try:
                ...
                save_exception(
                    e, module="jarvis_c2rust.scanner", function="_sym_record_from_type"
                )
                pass
        return {
            "id": id_val,
        ...
        for line in f:
            ...
            try:
                ...
                save_exception(
                    e,
                    module="jarvis_c2rust.scanner",
                    function="_resolve_symbols_jsonl_path",
                )
                continue
            idx += 1

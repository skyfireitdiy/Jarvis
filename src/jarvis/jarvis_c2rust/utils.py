...
from jarvis.jarvis_utils.config import calculate_token_limit, get_max_input_token_count, save_exception
    ...
    with order_jsonl.open("r", encoding="utf-8") as f:
        for ln in f:
            ...
            try:
                ...
                save_exception(e, module="jarvis_c2rust.utils", function="iter_order_steps")
                continue
...
def truncate_git_diff_with_context_limit(
    ...
    if agent:
        try:
            ...
            save_exception(e, module="jarvis_c2rust.utils", function="truncate_git_diff_with_context_limit")
            pass

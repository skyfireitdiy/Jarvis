...
def ensure_mod_chain_for_module(crate_dir: Path, module: str) -> None:
    ...
    try:
        ...
        save_exception(e, module="jarvis_c2rust.transpiler_mod_utils", function="ensure_mod_chain_for_module")
        pass
...
def module_file_to_crate_path(crate_dir: Path, module: str) -> str:
    ...
    try:
        ...
        save_exception(e, module="jarvis_c2rust.transpiler_mod_utils", function="module_file_to_crate_path")
        pass
    # 规范化 ./ 前缀
    if mod.startswith("./"):
        mod = mod[2:]

...
"""),
    ...
    def test_restore_file_from_cache_with_file_ends_with_newline(self, tool):
        ...
        assert "return 1\n\n\ndef func2()" in restored or "return 1\n\ndef func2()" in restored
        # 验证最后有换行符
        assert restored[-1] == '\n'
    ...
    def test_restore_file_from_cache_preserves_newlines_after_edit(self, tool, mock_agent):
        ...
        try:
            ...
            # 验证块之间的换行符正确（block-1以\n结尾，块之间插入\n，block-2以\n开头，所以是\n\n）
            assert "return 999\n\n\ndef func2()" in restored or "return 999\n\ndef func2()" in restored
            # 验证修改后的内容存在
            assert "return 999" in restored

...
class TestSessionManager:
    ...
    @patch('os.makedirs')
    def test_save_session_with_special_chars(self, mock_makedirs, session_manager, mock_model):
        """测试带特殊字符的模型名称"""
    ...
    @patch('os.path.exists')
    def test_restore_session_restore_failure(self, mock_exists, session_manager, mock_model):
        """测试恢复会话失败的情况"""
        mock_exists.return_value = True

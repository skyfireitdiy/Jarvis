...
class TestPlatformRegistry:
    ...
    def test_get_platform_dir_existing(self, mock_makedirs, mock_exists, mock_get_data_dir):
        """测试获取已存在的平台目录"""
    ...
    @patch("jarvis.jarvis_platform.registry.os.makedirs")
    @patch("builtins.open")
    def test_get_platform_dir_create(self, mock_open, mock_makedirs, mock_exists, mock_get_data_dir):
        """测试创建平台目录"""
        mock_get_data_dir.return_value = "/test/data"

...
class TestSymbolTableDB:
    ...
    def test_get_file_symbols(self, temp_db):
        ...
        temp_db.add_symbol(name="func1", kind="function", file_path="/test/file.py", line_start=1, line_end=10)
        temp_db.add_symbol(name="func2", kind="function", file_path="/test/file.py", line_start=15, line_end=25)
        temp_db.add_symbol(name="func3", kind="function", file_path="/other/file.py", line_start=1, line_end=10)
    ...
    def test_add_edge(self, temp_db):
        ...
        # Add two symbols
        temp_db.add_symbol(name="caller", kind="function", file_path="/test/file.py", line_start=1, line_end=10)
        temp_db.add_symbol(name="callee", kind="function", file_path="/test/file.py", line_start=20, line_end=30)
    ...
    def test_get_symbol_edges_both_directions(self, temp_db):
        ...
        temp_db.add_symbol(name="a", kind="function", file_path="/test/file.py", line_start=1, line_end=10)
        temp_db.add_symbol(name="b", kind="function", file_path="/test/file.py", line_start=20, line_end=30)

        temp_db.add_edge(source_id="/test/file.py:a:1", target_id="/test/file.py:b:20", kind="calls")
